...
public class DefaultTestProfile implements QuarkusTestProfile {
	...
	public Map<String, String> getConfigOverrides() {
		...
		configOverrides.putAll(Map.of("com.redhat.rover.carsim.route", "src/test/resources/gps/gpx/test",
		...
		configOverrides.putAll(Map.of(
			"mp.messaging.outgoing.zonechangepub.topic", "rover/zonechange",
		...
		configOverrides.putAll(Map.of(
			"mp.messaging.outgoing.enginemetrics.topic", "rover/enginemetrics",
		...
		configOverrides.putAll(Map.of(
			"mp.messaging.incoming.enginemetricscons.topic", "rover/enginemetrics",
